...
SELECT  vendor_id, count (vendor_id) as rent_number
...
SELECT customer.customer_last_name, customer.customer_first_name, customer.customer_id, SUM(customer_purchases.quantity*customer_purchases.cost_to_customer_per_qty) as money_spent
FROM customer
